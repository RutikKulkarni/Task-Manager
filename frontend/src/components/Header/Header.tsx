    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex flex-col md:flex-row items-center bg-gray-50 p-6 rounded-lg shadow-md">
          <IoIosPricetags className="hidden lg:block w-16 h-16 mb-4 md:mb-0 md:mr-4 text-purple-600"/>
          <div>
        ...
        <div className="flex flex-col md:flex-row items-center bg-gray-50 p-6 rounded-lg shadow-md">
          <HiOutlineShare className="hidden lg:block w-16 h-16 mb-4 md:mb-0 md:mr-4 text-purple-600"/>
          <div>
            <h2 className="text-lg font-semibold text-gray-800">
        ...
        <div className="flex flex-col md:flex-row items-center bg-gray-50 p-6 rounded-lg shadow-md">
          <ImEarth className="hidden lg:block w-16 h-16 mb-4 md:mb-0 md:mr-4 text-purple-600"/>
